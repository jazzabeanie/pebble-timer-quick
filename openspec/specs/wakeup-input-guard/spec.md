...
Ignore button presses that begin just after an alarm (wakeup) launch, so that a press already in progress cannot act on the alarm before the user has seen it.
